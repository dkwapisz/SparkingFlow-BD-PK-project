...
def generate_top_games_non_casual(spark, output_path):
    ...
    non_cas.show()
    non_cas.toPandas().to_csv(output_path + "/Top Games Non-Casual.csv", header=True)

    generate_games_chart(
        title="Top 3 Games for Non-Casual Gamers - Podium",
        ylabel="Recommendations by Non-Casual Gamers",
        output_path=output_path + "/Top Games Non-Casual.png",
...
generate_top_games_non_casual(spark, output_path)
