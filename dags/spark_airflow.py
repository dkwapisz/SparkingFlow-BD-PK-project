...
# start >> health_check >> load_sample_job >> load_games_to_bronze_job >> partition_data_job >> translate_reviews_job >> include_games_data_job >> save_to_db_job >> analytics_job >> end
(
    start
    >> health_check
    >> load_games_to_bronze_job
    >> partition_data_job
